...
Page({
      ...
      wx.request({
        ...
        success: (res) => {
          ...
          resolve({
            ...
            L: response.data.datastreams[2].datapoints.reverse()
  ...
  convert: function (datapoints) {
    ...
    var length = datapoints.L.length
    for (var i = 0; i < length; i++) {
      categories.push(datapoints.L[i].at.slice(5, 19));
      // humidity.push(datapoints.humidity[i].value);
      L.push(datapoints.L[i].value);
